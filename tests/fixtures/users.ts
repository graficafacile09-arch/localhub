...
export const UTENTI = {
  ...
  merchantA: {
    chiave: "merchantA",
    email: "merchant-a.test@localhub.it",
    password: "MerchantTest123!",
    fullName: "Merchant A Test",
    ruolo: "merchant",
  },
  merchantB: {
    chiave: "merchantB",
    email: "merchant-b.test@localhub.it",
    password: "MerchantTest123!",
    fullName: "Merchant B Test",
    ruolo: "merchant",
  },
  merchantC: {
    chiave: "merchantC",
    email: "merchant-c.test@localhub.it",
    password: "MerchantTest123!",
    fullName: "Merchant C Test",
    ruolo: "merchant",
  },
  merchantD: {
    chiave: "merchantD",
    email: "merchant-d.test@localhub.it",
    password: "MerchantTest123!",
    fullName: "Merchant D Test",
    ruolo: "merchant",
  },
  customerA: {
    chiave: "customerA",
