  ...
  switch (stato) {
    case "in_preparazione":
      return {
        ...
        descrizioneVenditore: "Ordine appena ricevuto: accettalo per avviare subito la preparazione.",
    ...
    case "in_lavorazione":
      return {
        ...
        descrizioneVenditore: "Preparazione in corso: quando è pronto, passa alla spedizione o al ritiro.",
        banner: "border-yellow-200 bg-yellow-50/70",
        testo: "text-yellow-950",
        badge: "bg-yellow-50 text-yellow-700 ring-1 ring-yellow-200",
        iconaTesto: "text-yellow-600",
