 ...
 * né su mobile (Home, Negozi, Categorie, Carrello, Account). L'accesso
 * amministratore avviene esclusivamente dall'ingresso dedicato /admin.
 *
 ...
 *   tasti principali (Home, Negozi, Categorie) compatta e responsive, senza
