...
export default function ClienteProfiloModule() {
  ...
  // ── Sezione sicurezza / cambio password (ex pagina Impostazioni) ────────
  ...
  return (
    <div className="space-y-5">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-3 max-w-xl text-sm leading-6 text-slate-600">
                Il punto unico per i tuoi dati: anagrafica, indirizzo, avatar
                e sicurezza dell&apos;account (cambio password). L&apos;email è
                legata al tuo account e non è modificabile.
              </p>
            </div>
          </div>
      ...
      {/* ── Sicurezza: cambio password (ex pagina Impostazioni) ─────────────── */}
      <div className="rounded-[2rem] border border-white/70 bg-white p-6 shadow-sm md:p-8">
