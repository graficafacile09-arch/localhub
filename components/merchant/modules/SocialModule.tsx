  ...
  return (
    <ModuleShell icon={<MessageCircle className="h-4 w-4" />} title="Social" subtitle="Link a profili social" id="social">
      <div className="space-y-4">
        <SocialField icon={<MessageCircle className="h-4 w-4 text-green-600" />} label="WhatsApp" value={form.whatsapp} onChange={(v) => setForm((f) => ({ ...f, whatsapp: v }))} placeholder="+39 333 1234567" prefix="" />
        ...
        <SocialField icon={<Video className="h-4 w-4 text-red-600" />} label="YouTube" value={form.youtube} onChange={(v) => setForm((f) => ({ ...f, youtube: v }))} prefix="youtube.com/@" placeholder="nome.negozio" />
