            ...
            {fatto ? (
              <div className="flex flex-col items-center gap-2 px-5 py-10 text-center">
                ...
                <button
                  type="button"
                  onClick={chiudi}
                  className="mt-2 rounded-xl border border-blue-200 bg-blue-50 px-5 py-2 text-xs font-bold text-blue-700 transition hover:border-blue-300 hover:bg-blue-100 hover:text-blue-800"
                >
                  Chiudi
                </button>
              </div>
