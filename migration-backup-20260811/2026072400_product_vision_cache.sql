...
drop policy if exists "vision cache public read" on public.product_vision_cache;
create policy "vision cache public read"
  on public.product_vision_cache for select
  using (true);

drop policy if exists "vision cache public insert" on public.product_vision_cache;
create policy "vision cache public insert"
  on public.product_vision_cache for insert
  with check (true);

drop policy if exists "vision cache public update" on public.product_vision_cache;
create policy "vision cache public update"
