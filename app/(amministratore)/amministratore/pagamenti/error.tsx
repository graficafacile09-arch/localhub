...
export default function AmministratorePagamentiError({
  error,
  unstable_retry,
}: {
  ...
  useEffect(() => {
    console.error("[amministratore-pagamenti-error] Errore area pagamenti", error);
  }, [error]);
  ...
  return (
    <div className="card p-10 text-center">
      ...
      <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-slate-600">
        Si è verificato un errore durante il caricamento della sezione pagamenti. Riprova tra qualche istante.
      </p>
      <button
        type="button"
