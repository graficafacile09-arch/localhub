...
export const metadata = {
  title: "Prodotti del negozio — Amministratore",
};

export const dynamic = "force-dynamic";

/**
 * Catalogo prodotti del singolo negozio nell'Area Amministratore.
 * Stesso sistema del venditore: elenco, creazione, modifica ed eliminazione
 * prodotti con i componenti condivisi (MerchantProductForm, wizard AI, delete).
 */
export default async function AdminStoreProdottiPage({
  params,
}: {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <p className="text-xs font-semibold uppercase tracking-[0.22em] text-blue-700">
              Area Amministratore — Catalogo
            </p>
            <h1 className="mt-2 text-3xl font-black tracking-tight text-slate-900">
              Prodotti di {storeResult.data.nome}
            </h1>
            <p className="mt-3 text-sm leading-6 text-slate-600">
              Gestisci il catalogo del negozio con lo stesso sistema del venditore: AI, modifica ed eliminazione incluse.
            </p>
          </div>
      ...
      {/* Banner AI se il catalogo è vuoto */}
