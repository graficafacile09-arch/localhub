...
/**
 * Error boundary del dettaglio negozio amministratore.
 * Mostra un messaggio professionale e consente di riprovare.
 */
export default function NegozioAmministratoreDetailError({
  error,
  unstable_retry,
}: {
  ...
  return (
    <div className="card p-10 text-center">
      ...
      <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-slate-600">
        Si è verificato un errore durante il caricamento del dettaglio negozio.
      ...
      <div className="mt-3">
        <BackButton label="Torna ai negozi" />
      </div>
    </div>
  );
}