...
/**
 * Error boundary della sezione Pagamenti Venditore.
 * Mostra un messaggio professionale e consente di riprovare.
 */
export default function PagamentiVenditoreError({
  error,
  unstable_retry,
}: {
  ...
  return (
    <div className="card p-10 text-center">
      ...
      <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-slate-600">
        Si è verificato un errore durante il caricamento della configurazione pagamenti.
