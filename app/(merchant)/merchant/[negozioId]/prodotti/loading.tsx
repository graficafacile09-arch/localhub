/**
 * Stato di caricamento della sezione Prodotti Venditore.
 * Skeleton mostrato durante lo streaming del catalogo prodotti.
 */
export default function ProdottiVenditoreLoading() {
  return (
