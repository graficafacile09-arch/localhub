          ...
          {categorie.map((categoria, index) => {
            ...
            return (
              <Link
                ...
                className="group flex flex-col items-center gap-2 rounded-xl bg-white p-3 md:p-4 transition-all duration-200 hover:shadow-sm hover:-translate-y-0.5 ring-1 ring-slate-100"
              >
                <div className={`flex h-10 w-10 md:h-12 md:w-12 items-center justify-center rounded-lg bg-gradient-to-br from-slate-50 to-slate-100 transition-all duration-200 ${stile.box} group-hover:scale-110`}>
