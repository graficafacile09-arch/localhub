    ...
    return (
      <main className="flex min-h-screen items-center justify-center bg-gray-50 px-4">
        <div className="w-full max-w-md rounded-2xl bg-white p-8 text-center shadow-sm ring-1 ring-slate-100">
          ...
          <Link
            href="/"
            className="mt-4 inline-flex items-center gap-2 rounded-xl bg-blue-600 px-5 py-2.5 text-sm font-bold text-white transition hover:bg-yellow-400 hover:text-blue-900"
          >
        ...
        <div className="mt-4 rounded-[1.75rem] border border-white/70 bg-white p-5 shadow-sm">
          ...
          {utente ? (
            <>
              ...
              <Link
                href="/cliente/ordini"
                className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-blue-600 px-5 py-3 text-sm font-bold text-white transition hover:bg-yellow-400 hover:text-blue-900 sm:w-auto"
              >
